...
const LoginRequiredModal = ({ show, onHide }) => {
  ...
  return (
    <Modal show={show} onHide={onHide} centered>
      ...
      <Modal.Body style={{ textAlign: 'center', padding: '30px' }}>
        ...
        <h5 style={{ marginBottom: '15px' }}>Please Login to Continue</h5>
        <p style={{ color: '#666' }}>
          You need to be logged in to add items to wishlist, cart, or make a purchase.
        </p>
        <p style={{ color: '#666' }}>
